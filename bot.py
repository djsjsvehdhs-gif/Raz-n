...
from playwright_stealth import stealth_async, stealth # Importamos ambas por seguridad
...
async def bypass_logic(url, site_type):
    async with async_playwright() as p:
        ...
        # Intentamos usar stealth_async y si falla usamos stealth (que es el nuevo estándar)
        try:
